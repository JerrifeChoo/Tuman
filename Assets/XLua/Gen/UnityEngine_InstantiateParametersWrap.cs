...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineInstantiateParametersWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.InstantiateParameters);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.InstantiateParameters));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.InstantiateParameters constructor!");
        ...
        static int _g_get_parent(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.InstantiateParameters gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
