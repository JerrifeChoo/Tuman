...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit4(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UnityEngine.InstantiateParameters), UnityEngineInstantiateParametersWrap.__Register);
        ...
        static void wrapInit7(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UnityEngine.SpriteMaskUtility), UnityEngineSpriteMaskUtilityWrap.__Register);
        ...
        static void wrapInit9(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(ApplicationIntance), ApplicationIntanceWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(TimerTestBehaviour), TimerTestBehaviourWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Readme), ReadmeWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(TT.Timer.CallbackTag), TTTimerCallbackTagWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(TT.Timer.DestroyTag), TTTimerDestroyTagWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(TT.Timer.HandleSystem), TTTimerHandleSystemWrap.__Register);
