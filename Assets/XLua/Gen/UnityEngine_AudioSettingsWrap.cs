...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioSettingsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 8, 5, 3);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "audioSpatialExperience", _g_get_audioSpatialExperience);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "audioSpatialExperience", _s_set_audioSpatialExperience);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_audioSpatialExperience(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.AudioSettings.audioSpatialExperience);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_audioSpatialExperience(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			UnityEngine.AudioSpatialExperience gen_value;translator.Get(L, 1, out gen_value);
				UnityEngine.AudioSettings.audioSpatialExperience = gen_value;
